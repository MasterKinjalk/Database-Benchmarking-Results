...
where 
	ss_item_sk = i_item_sk 
  	...
  	and ss_sold_date_sk = d_date_sk
	and d_date between DATE '1999-02-05'
				and DATE '1999-02-05' + INTERVAL '30' day
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
and d_date between DATE '2000-02-01' and 
        DATE '2000-02-01' + INTERVAL '90' day
...
where
    d_date between DATE '2001-4-01' and 
           DATE '2001-4-01' + INTERVAL '60' day
...
select  
   w_state
  ,i_item_id
  ,sum(case when d_date < DATE '2001-05-02' 
 ...
 and cs_warehouse_sk    = w_warehouse_sk 
 and cs_sold_date_sk    = d_date_sk
 and d_date between DATE '2001-05-02' - INTERVAL '30' day
